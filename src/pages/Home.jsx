...
export const Home = () => {
    ...
    return (
        <main className="bg-primary h-screen dark:bg-primary-dark flex flex-col items-center justify-center overflow-hidden">
            <section className="rounded-lg min-w-[450px] px-3">
                <h1 className="text-black dark:text-white text-4xl font-bold mb-4 flex items-center gap-4">PROYECTOS 
                    <Icon icon="skill-icons:tailwindcss-dark" width="40" height="40" /></h1>
                {
        ...
        <button className="p-2 mt-3 rounded-lg bg-white dark:bg-black text-black dark:text-white font-semibold" onClick={toggleTheme}>
